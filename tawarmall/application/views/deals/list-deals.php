          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo $i;?></td>
                    <td><?php echo $listing->deals_id;?> </td>
                  ...
                  <td><?php echo $listing->timming;?></td>
                  <td><img src="<?php echo ext_path;?>deals/<?php echo $listing->image;?>" height="50px" width="50px"></td>
...
<script>
							...
							function get_status(id){
										...
										//	alert(org);
											$.ajax({
											type:"post",
											url:"<?php echo page_url;?>Tenants/change_deal_status",
