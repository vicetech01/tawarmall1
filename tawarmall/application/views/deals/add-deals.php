  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <form name="frm" action="<?php echo page_url;?>Tenants/add_deals" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
          ...
          <div class="col-md-3">
              <div class="form-group">
                ...
                <select name="type" id="type" class="form-control"  placeholder="Title" >
                <option value="1" selected>Deals</option>
                </select>
                
               <!-- <input type="radio" name="type" id="type" value="2" placeholder="Title" onChange="changetype();">&nbsp;Events &nbsp;-->
            ...
            <div class="col-md-5">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="des" id="des" placeholder="Description"></textarea>
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control" placeholder="Duration" name="time" id="time">
              
              </div>
              </div>
              
              
                <div class="col-md-3" style="display:none" id="timing">
            
              <div class="form-group" >
                <label>Timmings </label>
               <input type="text" class="form-control" placeholder="Timmings" name="time1" id="time">
