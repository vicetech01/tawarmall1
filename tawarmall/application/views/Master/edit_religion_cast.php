  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Religion Cast</h3>
...
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Religion_cast/update_religion_cast">
        <input type="hidden" name="religion_cast_id" value="<?php echo $edit_record->religion_cast_id;?>">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
              
                <label>Religion<span style="color:red;">*</span> <?php echo form_error('religion');?></label>
                <select class="form-control" name="religion" id="religion">
                <?php 
					$this->db->select('a.*,b.religion_id,b.religion as RELIGION');
					$this->db->from('religion_cast a');
					$this->db->where('a.religion_cast_id',$edit_record->religion_cast_id);
					$this->db->join('religion b','a.religion=b.religion_id','left');
					$query = $this->db->get();
					$res_cast =$query->result();
					//echo "<pre>"; print_r($res_cast); exit;
					foreach($res_cast as $religion_cast)
					{
					
					?>
                    <option value="<?php echo $edit_record->religion;?>"><?php echo $religion_cast->RELIGION;?></option>
					<?php }?>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>Cast<span style="color:red;">*</span> <?php echo form_error('cast');?></label>
                <input type="text" class="form-control" placeholder="Cast" name="cast" id="cast" value="<?php echo $edit_record->religion_cast;?>">
              </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Religion Cast List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
				    $i=1;
					$this->db->select('a.*,b.religion as Religion,b.religion_id');
					$this->db->from('religion_cast a');
					$this->db->join('religion b','a.religion=b.religion_id','left');
					$query = $this->db->get();
					$result =$query->result();
                ...
                <tr>
                  ...
                  <td><?php echo $row->religion_cast;?></td>
                   <td><?php if($row->status=='1'){$status = "<button type='button' class='btn btn-block btn-success btn-xs'>Active</button>";}else{$status="<button type='button' class='btn btn-block btn-danger btn-xs'>Inactive</button>";}?><a href="<?php echo page_url;?>Masters/Religion_cast/update_religion_cast_status/<?php echo $row->status;?>/<?php echo $row->religion_cast_id;?>"><?php echo $status;?></a></td>
                  <td><a href="<?php echo page_url;?>Masters/Religion_cast/edit_religion_cast/<?php echo $row->religion_cast_id;?>"><i class="fa fa-pencil"></i></a> &nbsp; &nbsp; <a href="<?php echo page_url;?>Masters/Religion_cast/delete_religion_cast/<?php echo $row->religion_cast_id;?>"><i class="fa fa-trash"></i></a></td>
