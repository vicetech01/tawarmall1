...
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Education/add_education">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Qualification<span style="color:red;">*</span> <?php echo form_error('qualification');?></label>
                <input type="text" class="form-control" placeholder="Qualification" name="qualification" id="qualification" value="">
              </div>
