...
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Profile_for/add_profile_for">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Profile For<span style="color:red;">*</span> <?php echo form_error('profile_for');?></label>
                <input type="text" class="form-control" placeholder="Profile For" name="profile_for" id="profile_for" value="">
              </div>
