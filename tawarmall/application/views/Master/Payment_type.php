...
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Payment_type/add_payment_type">
          <div class="row">
            <div class="col-md-5">
              <div class="form-group">
                <label>Payment Type<span style="color:red;">*</span> <?php echo form_error('payment_type');?></label>
                <input type="text" class="form-control" placeholder="Payment Type" name="payment_type" value="">
              </div>
            ...
            <div class="col-md-5">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Credit Value" name="credit_value" value="">
              </div>
