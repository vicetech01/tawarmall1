...
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Payment_type/update_payment_type">
        <input type="hidden" name="payment_type_id" value="<?php echo $edit_record->payment_type_id;?>">
          <div class="row">
            <div class="col-md-5">
              <div class="form-group">
                <label>Payment Type<span style="color:red;">*</span> <?php echo form_error('payment_type');?></label>
                <input type="text" class="form-control" placeholder="Payment Type" name="payment_type" value="<?php echo $edit_record->payment_type;?>">
              </div>
            ...
            <div class="col-md-5">
              <div class="form-group">
                <label>Credit Value<span style="color:red;">*</span> <?php echo form_error('credit_value');?></label>
                <input type="text" class="form-control" placeholder="Credit Value" name="credit_value" value="<?php echo $edit_record->credit_value;?>">
              </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row->credit_value;?></td>
                   <td><?php if($row->status=='1'){$status = "<button type='button' class='btn btn-block btn-success btn-xs'>Active</button>";}else{$status="<button type='button' class='btn btn-block btn-danger btn-xs'>Inactive</button>";}?><a href="<?php echo page_url;?>Masters/Payment/update_payment_type_status/<?php echo $row->status;?>/<?php echo $row->payment_type_id;?>"><?php echo $status;?></a></td>
                  <td><a href="<?php echo page_url;?>Masters/Payment_type/edit_payment_type/<?php echo $row->payment_type_id;?>"><i class="fa fa-pencil"></i></a> &nbsp; &nbsp; <a href="<?php echo page_url;?>Masters/Payment_type/delete_payment_type/<?php echo $row->payment_type_id;?>"><i class="fa fa-trash"></i></a></td>
