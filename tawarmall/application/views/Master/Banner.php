  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Home Page Banner Management</h3>
        ...
        <div class="box-body">
          <div class="row">
          <form method="post" action="<?php echo page_url;?>Masters/Slider/add_slider" enctype="multipart/form-data">
            <div class="col-md-6">
            <?php echo form_error('name');?>
              <div class="form-group">
                <label>Image Title</label>
                <input type="text" class="form-control" placeholder="Image Title" name="name">
              </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo page_url;?>Masters/Slider/edit_slider/<?php echo $row->banner_id;?>"><i class="fa fa-pencil"></i></a>&nbsp; &nbsp;<a href="<?php echo page_url;?>Masters/Slider/delete_slider/<?php echo $row->banner_id;?>"><i class="fa fa-trash"></i></a></td>
                </tr>
               <?php $i++;}?>
                </tbody>
