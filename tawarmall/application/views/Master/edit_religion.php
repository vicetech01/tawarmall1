...
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Religion/update_religion">
        <input type="hidden" name="religion_id" value="<?php echo $edit_record->religion_id;?>">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Religion<span style="color:red;">*</span> <?php echo form_error('religion');?></label>
                <input type="text" class="form-control" placeholder="Religion" name="religion" id="religion" value="<?php echo $edit_record->religion;?>">
              </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row->religion;?></td>
                   <td><?php if($row->status=='1'){$status = "<button type='button' class='btn btn-block btn-success btn-xs'>Active</button>";}else{$status="<button type='button' class='btn btn-block btn-danger btn-xs'>Inactive</button>";}?><a href="<?php echo page_url;?>Masters/Religion/update_religion_status/<?php echo $row->status;?>/<?php echo $row->religion_id;?>"><?php echo $status;?></a></td>
                  <td><a href="<?php echo page_url;?>Masters/Religion/edit_religion/<?php echo $row->religion_id;?>"><i class="fa fa-pencil"></i></a> &nbsp; &nbsp; <a href="<?php echo page_url;?>Masters/Religion/delete_religion/<?php echo $row->religion_id;?>"><i class="fa fa-trash"></i></a></td>
