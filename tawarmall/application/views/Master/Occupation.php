...
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Occupation/add_occupation">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Occupation<span style="color:red;">*</span> <?php echo form_error('Occupation');?></label>
                <input type="text" class="form-control" placeholder="Occupation" name="Occupation" id="Occupation" value="">
              </div>
