...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.html" class="btn btn-primary btn-block margin-bottom">Master </a>
		...
		foreach($edit_rec as $edit_record)?>
        ...
        <div class="box-body">
          <div class="row">
          <form method="post" action="<?php echo page_url;?>Masters/Slider/update_slider" enctype="multipart/form-data">
          <input type="hidden" name="banner_id" value="<?php echo $edit_record->banner_id;?>">
          <input type="hidden" name="old_image" value="<?php echo $edit_record->banner;?>">
            <div class="col-md-6">
            <?php echo form_error('name');?>
              <div class="form-group">
                <label>Image Title</label>
                <input type="text" class="form-control" placeholder="Image Title" name="name" value="<?php echo $edit_record->banner_name;?>">
              </div>
            ...
            <?php echo form_error('upload');?>
              <div class="form-group">
                ...
                <img src="<?php echo upload_path;?>slider/<?php echo $edit_record->banner;?>" width="100px">
                <input type="file" class="form-control" name="upload" required="required" value="<?php echo $edit_record->banner;?>">
              </div>
              <div class="row">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img src="<?php echo upload_path;?>slider/<?php echo $row->banner;?>" width="100px"></td>
                  <td><?php if($row->banner_status=='1'){$status = "<button type='button' class='btn btn-block btn-success btn-xs'>Active</button>";}else{$status="<button type='button' class='btn btn-block btn-danger btn-xs'>Inactive</button>";}?><a href="<?php echo page_url;?>Masters/Slider/update_slider_status/<?php echo $row->banner_status;?>/<?php echo $row->banner_id;?>"><?php echo $status;?></a></td>
                  <td><a href=""><i class="fa fa-pencil"></i></a>&nbsp; &nbsp;<a href="<?php echo page_url;?>Masters/Slider/delete_slider/<?php echo $row->banner_id;?>"><i class="fa fa-trash"></i></a></td>
                </tr>
               <?php $i++;}?>
                </tbody>
