  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Mother Tongue</h3>
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Mother_tongue/add_mother_tongue">
          <div class="row">
            
            
            <div class="col-md-4">
              <div class="form-group">
                <label>Mother Tongue<span style="color:red;">*</span> <?php echo form_error('cast');?></label>
                <input type="text" class="form-control" placeholder="Mother Tongue" name="cast" id="cast" value="">
              </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row->religion_cast;?></td>
                   <td><?php if($row->status=='1'){$status = "<button type='button' class='btn btn-block btn-success btn-xs'>Active</button>";}else{$status="<button type='button' class='btn btn-block btn-danger btn-xs'>Inactive</button>";}?><a href="<?php echo page_url;?>Masters/Mother_tongue/update_religion_cast_status/<?php echo $row->status;?>/<?php echo $row->religion_cast_id;?>"><?php echo $status;?></a></td>
                  <td><a href="<?php echo page_url;?>Masters/Mother_tongue/edit_religion_cast/<?php echo $row->religion_cast_id;?>"><i class="fa fa-pencil"></i></a> &nbsp; &nbsp; <a href="<?php echo page_url;?>Masters/Mother_tongue/delete_religion_cast/<?php echo $row->religion_cast_id;?>"><i class="fa fa-trash"></i></a></td>
