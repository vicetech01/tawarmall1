  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Education/update_education">
        <input type="hidden" name="education_id" value="<?php echo $edit_record->education_id;?>">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Qualification<span style="color:red;">*</span> <?php echo form_error('qualification');?></label>
                <input type="text" class="form-control" placeholder="Qualification" name="qualification" id="qualification" value="<?php echo $edit_record->education;?>">
              </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Qualifications List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row->education;?></td>
                   <td><?php if($row->status=='1'){$status = "<button type='button' class='btn btn-block btn-success btn-xs'>Active</button>";}else{$status="<button type='button' class='btn btn-block btn-danger btn-xs'>Inactive</button>";}?><a href="<?php echo page_url;?>Masters/Education/update_education_status/<?php echo $row->status;?>/<?php echo $row->education_id;?>"><?php echo $status;?></a></td>
                  <td><a href="<?php echo page_url;?>Masters/Education/edit_education/<?php echo $row->education_id;?>"><i class="fa fa-pencil"></i></a> &nbsp; &nbsp; <a href="<?php echo page_url;?>Masters/Education/delete_education/<?php echo $row->education_id;?>"><i class="fa fa-trash"></i></a></td>
