...
<span><?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Masters/Occupation/update_occupation">
        <input type="hidden" name="occupation_id" value="<?php echo $edit_record->occupation_id;?>">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Occupation<span style="color:red;">*</span> <?php echo form_error('Occupation');?></label>
                <input type="text" class="form-control" placeholder="Occupation" name="Occupation" id="Occupation" value="<?php echo $edit_record->occupation;?>">
              </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row->occupation;?></td>
                   <td><?php if($row->status=='1'){$status = "<button type='button' class='btn btn-block btn-success btn-xs'>Active</button>";}else{$status="<button type='button' class='btn btn-block btn-danger btn-xs'>Inactive</button>";}?><a href="<?php echo page_url;?>Masters/Occupation/update_occupation_status/<?php echo $row->status;?>/<?php echo $row->occupation_id;?>"><?php echo $status;?></a></td>
                  <td><a href="<?php echo page_url;?>Masters/Occupation/edit_occupation/<?php echo $row->occupation_id;?>"><i class="fa fa-pencil"></i></a> &nbsp; &nbsp; <a href="<?php echo page_url;?>Masters/Occupation/delete_occupation/<?php echo $row->occupation_id;?>"><i class="fa fa-trash"></i></a></td>
