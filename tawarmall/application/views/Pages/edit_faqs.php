    ...
    <section class="content">
      <div class="row">
        ...
        <?php foreach($edit_rec as $edit_record)?>
          <h3 class="box-title"><?php if($edit_record){?>Edit<?php }else{?>Add New<?php }?> FAQ's</h3>
<?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Pages/Content/<?php if(isset($edit_record)){?>update_faqs<?php }?>">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="name" placeholder="FAQ's Question" value="<?php if(isset($edit_record)){ echo $edit_record->Page_name;}?><?php echo set_value('name');?>">
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <textarea class="form-control" name="meta_description" placeholder="Meta Description"><?php if(isset($edit_record)){ echo $edit_record->meta_description;}?><?php echo set_value('meta_description');?></textarea>
              </div>
            ...
            <div class="col-md-8">
              <div class="form-group">
                ...
                <textarea class="form-control" name="content" id="content" placeholder="FAQ's Answer"><?php if(isset($edit_record)){ echo $edit_record->description;}?><?php echo set_value('content');?></textarea>
