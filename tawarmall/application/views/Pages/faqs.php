...
<?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Pages/Content/FAQs">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label>FAQ's Question<span style="color:red;">*</span> <?php echo form_error('name');?></label>
                
                <input type="text" class="form-control" name="name" id="name" placeholder="FAQ's Question" value="<?php echo set_value('name');?>">
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Page Title" name="page_title" value="<?php echo set_value('page_title');?>">
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Meta Keywords" name="meta_keyword" value="<?php echo set_value('meta_keyword');?>">
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <textarea class="form-control" name="meta_description" placeholder="Meta Descripton"><?php echo set_value('meta_description');?></textarea>
              </div>
            ...
            <div class="col-md-8">
              <div class="form-group">
                <label>FAQ's Answer<span style="color:red">*</span> <?php echo form_error('content');?></label>
                
                <textarea class="form-control" name="content" id="content" placeholder="FAQ's Answer"><?php echo set_value('content');?></textarea>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php if($row->status=='1'){$status = "<button type='button' class='btn btn-block btn-success btn-xs'>Active</button>";}else{$status="<button type='button' class='btn btn-block btn-danger btn-xs'>Inactive</button>";}?><a href="<?php echo page_url;?>Pages/Content/update_faqs_status/<?php echo $row->status;?>/<?php echo $row->id;?>"><?php echo $status;?></a></td>
                  <td><a href="<?php echo page_url;?>Pages/Content/edit_faqs/<?php echo $row->id;?>"><i class="fa fa-pencil"></i></a> &nbsp; &nbsp; &nbsp;<a href="<?php echo page_url;?>Pages/Content/delete_faqs/<?php echo $row->id;?>"><i class="fa fa-trash"></i></a></td>
                </tr>
