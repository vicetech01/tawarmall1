...
<?php echo $this->session->flashdata('message'); ?></span>
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form method="post" action="<?php echo page_url;?>Pages/Content/<?php if(isset($edit_record)){?>update_about_us<?php }?>">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo page_url;?>Pages/Content/edit_page/<?php echo $row->id;?>"><i class="fa fa-pencil"></i></a> &nbsp; &nbsp; &nbsp;<a href="<?php echo page_url;?>Pages/Content/delete_about_us/<?php echo $row->id;?>"><i class="fa fa-trash"></i></a></td>
                </tr>
