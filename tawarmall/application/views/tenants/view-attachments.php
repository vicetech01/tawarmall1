  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		$this->db->select('*')->from('property_images')->where('tenant_id',$this->uri->segment('3'));
		$res=$this->db->get();
		
		$que=$res->result();
		
		foreach($que  as $attach)
		{
		...
		?>
            ...
            <div class="col-md-3">
              <div class="form-group">
               <img src="<?php echo ext_path;?><?php echo $attach->image;?>" height="50px"><br/>	
               <a href="<?php echo ext_path;?><?php echo $attach->image;?>">Download Image</a>
              </div>
