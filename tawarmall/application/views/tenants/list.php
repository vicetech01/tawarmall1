            ...
            <div class="box-body">
              <table id="example1" class="table-responsive table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $listing->fullname;?></td>
                  <td><?php echo $listing->email;?></td>
                  <td><?php echo $listing->phone;?></td>
                  <td><?php echo $listing->category;?></td>
                  <td><?php echo $listing->brand_name;?></td>
                  <td><a href="<?php echo page_url;?>Tenants/attachments/<?php echo $listing->tenant_id;?>">View</a></td>
                  <td><?php echo $listing->description;?></td>
                  <td><?php echo $listing->shop_timing;?></td>
