            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <td><?php if($listing->image<>''){?>
                 <img src="<?php echo ext_path;?>logrequest/<?php echo $listing->image;?>" height="50px"><br/><a href="<?php echo ext_path;?>logrequest/<?php echo $listing->image;?>">Download</a>
                 <?php
				 }else
				 {
					 echo "NA";
