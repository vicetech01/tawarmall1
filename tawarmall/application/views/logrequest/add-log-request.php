  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <form name="frm" action="<?php echo page_url;?>Tenants/add_log_request" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
          ...
          <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="radio" name="type" id="type" value="H" placeholder="Title">&nbsp;High
                
                 <input type="radio" name="type" id="type" value="M" placeholder="Title" >&nbsp;Medium
                 
                  <input type="radio" name="type" id="type" value="L" placeholder="Title" >&nbsp;Low
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sub" value="" placeholder="Subject">
             ...
             <div class="col-md-3">
              <div class="form-group">
                <label>Image </label>
                <input type="file" class="form-control" name="image" value="" placeholder="Subject">
