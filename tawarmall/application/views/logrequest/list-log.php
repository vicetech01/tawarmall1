            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php if($listing->priority=='H')
				  {
					$S="High";
					  
				  }else if($listing->priority=='M')
				  {
					$S="Medium";  
				  }else
				  {
                  ...
                  <td><?php echo $listing->subject;?></td>
                  <td><img src="<?php echo ext_path;?>logrequest/<?php echo $listing->image;?>"></td>
                  <td><?php echo $listing->message;?></td>
                 ...
                 <a href="<?php echo page_url;?>Tenants/change_log_status/<?php echo $listing->status;?>/<?php echo $listing->id;?>"><span class="btn btn-xs btn-<?php echo $b;?>"><?php echo $a;?></span></a>
