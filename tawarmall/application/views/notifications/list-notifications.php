      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table-responsive table-bordered table-striped" width="100%">
                <thead>
                <tr>
                  <th>Sno.</th>
                ...
                <tr>
                  <td><?php echo $i;?></td>
                    ...
                    <td><?php echo $listing->tenant_id;?> </td>
                    <?php
					$this->db->select('*')->from('hoosk_tenant')->where('tenant_id',$listing->tenant_id);
					$que=$this->db->get();
					$res=$que->result();
					foreach($res as $rest);
					
					?>
                  <td><?php echo $rest->fullname;?></td>
                  <td><?php echo $rest->brand_name;?></td>
                 ...
                 <td><?php echo $listing->url;?></td>
                  ...
                  <td><img src="<?php echo ext_path;?>notifications/<?php echo $listing->image;?>" height="100px" width="100px"><br/><a href="<?php echo ext_path;?>notifications/<?php echo $listing->image;?>" target="_blank">Download Image</a></td>
                  ...
                  <select name="sel" id="sel<?php echo $listing->id;?>" onChange="get_status(<?php echo $listing->id;?>);">
                  
                  <option value="">Select Status</option>
                  <option value="1" <?php if($listing->status=='1'){?> selected <?php
				  }
				  ?>>Approve</option>
                  <option value="0" <?php if($listing->status=='0'){?> selected <?php
				  }
				  ?>>Decline</option>
                  <option value="2" <?php if($listing->status=='2'){?> selected <?php
				  }
				  ?>>Onhold</option>
                  
                  <option value="3" <?php if($listing->status=='3'){?> selected <?php
				  }
				  ?>>Under Review</option>
                  
                  
                  </select>
                <!-- <a href="<?php //echo page_url;?>Tenants/change_not_status/<?php //echo $listing->status;?>/<?php //echo $listing->id;?>"><span class="btn btn-xs btn-<?php //echo $b;?>"><?php //echo $a;?></span></a>-->
...
<script>
							...
							function get_status(id){
										...
										//	alert(org);
											$.ajax({
											type:"post",
											url:"<?php echo page_url;?>Tenants/change_not_status",
											data:"status="+org+"&id="+id,
