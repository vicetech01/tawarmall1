...
<head>
  ...
  <title>Add Notification Amount</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <form name="frm" action="<?php echo page_url;?>Tenants/add_notiamount" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="form-control" name="noti" value="" >
                <option value="">Select Notification</option>
                <?php 
				$this->db->select('*')->from('notifications')->where('amount','0');
				$que=$this->db->get();
				$res=$que->result();
				foreach($res as $resty)
				{
				?>
                <option value="<?php echo $resty->id;?>"><?php echo $resty->notification_id;?></option>
                <?php
				}
				?>
                </select>
               <?php echo form_error('noti');?>
              </div>
