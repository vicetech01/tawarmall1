            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td> <?php echo $listing->article_name;?></td>
                  
                  <td><?php echo $listing->p_name;?></td>
                  <td><?php echo $listing->phone;?></td>
                  <td><img src="<?php echo ext_path;?>lostnfound/<?php echo $listing->image;?>" height="100px" width="100px"><br/>
                  <a href="<?php echo ext_path;?>lostnfound/<?php echo $listing->image;?>"> Download Image </a></td>
               ...
               <!--   <td><?php if($listing->status=='1')
                 ...
                 <a href="<?php echo page_url;?>Tenants/change_lost_status/<?php echo $listing->status;?>/<?php echo $listing->id;?>"><span class="btn btn-xs btn-<?php echo $b;?>"><?php echo $a;?></span></a>
