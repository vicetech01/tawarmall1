...
<head>
  ...
  <title>Add Lost Found Request</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <form name="frm" action="<?php echo page_url;?>Tenants/add_lost_found_request" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="aname" value="" placeholder="Article Name">
