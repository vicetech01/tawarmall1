  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <form name="frm" action="<?php echo page_url;?>Tenants/add_product" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                <label>Product Code</label>
                <input type="text" class="form-control" name="pcode" value="" placeholder="Product Code">
            ...
            <div class="col-md-3">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="cat" id="cat" placeholder="Product Category">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="price" id="price" placeholder="Product Price" onkeypress="return isNumberKey(event);">
